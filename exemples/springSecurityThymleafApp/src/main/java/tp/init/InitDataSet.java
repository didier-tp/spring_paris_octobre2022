...
public class InitDataSet {
	...
	public void initJeuxDeDonneesQueJaime() {
		...
		Client client1 = clientService.sauvegarderClient(new Client(null,"Bon", "jean",encodedPwd));
		...
		Client client2 = clientService.sauvegarderClient(new Client(null,"Therieur", "alex",passwordEncoder.encode("pwd2")));
